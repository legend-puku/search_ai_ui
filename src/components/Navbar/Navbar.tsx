  ...
  return (
    <>
      ...
      >
        <nav
          className={classnames(
            " absolute left-0 bottom-0 top-0  md:flex-grow-1 w-9/12 md:w-[260px] bg-[#984F4F] text-white z-10 flex flex-col transition duration-500",
        ...
        >
          ...
          <div className="account  font-bold  z-20 bg-[#984F4F] border-t border-gray-500 shadow  ">
